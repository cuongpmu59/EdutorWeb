...
<body>
  <div class="question-container">
    ...
    <form id="questionForm" enctype="multipart/form-data">
      ...
      <div>
        <label><input type="checkbox" id="togglePreview" onclick="togglePreview()"> Hiện xem trước từng phần</label>
      ...
      <div class="form-actions">
        <div class="form-left">
          ...
          <button type="reset" onclick="resetPreview()">Xoá trắng</button>
