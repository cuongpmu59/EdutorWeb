...
const previewFields = [
  ...
  // Cập nhật toàn bộ nội dung vào saPreviewContent
  function updateFullPreview() {
    const topic = document.getElementById('sa_topic')?.value.trim() || '';
    const answerSelect = document.getElementById('sa_correct_answer');
  ...
  function setupRealtimePreview() {
    ...
    const correctAnswerEl = document.getElementById('sa_correct_answer');
    if (correctAnswerEl) {
